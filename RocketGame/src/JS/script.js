...
rocketImg.src = '/src/Images/Rocket.png'; // Ensure 'Rocket.png' is in the correct folder

/* Load the explosion image */
const explodeImg = new Image();
explodeImg.src = '/src/Images/Explode.png'; // Ensure 'Explode.png' is in the correct folder
...
// 55% chance to crash between 1x and 3x, 45% chance between 3x and 50x
...
function updateGame() {
  ...
  if (multiplier >= crashPoint) {
    ...
    drawExplosion();
    // Show explosion for 1 second before resetting the game
    setTimeout(() => {
